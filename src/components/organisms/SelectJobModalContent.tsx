...
interface ISelectJobModalContent {
  onClickSelectNextTimeButton: VoidFunction;
}

const SelectJobModalContent = ({ onClickSelectNextTimeButton }: ISelectJobModalContent) => {
  return (
    <div
      css={css`
        ${flexColumn}
...
export default SelectJobModalContent;
