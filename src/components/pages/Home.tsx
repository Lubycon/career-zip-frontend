...
const Home = () => {
  return (
    <Flex flexDirection="column">
      <NavigationBar />
      <Section height="700px" bg="lightGray" padding="170px 0">
        <Heading as="h1" fontSize="52px" fontWeight="bold" textAlign="center" mb="auto">
          커리어 세이브 포인트 <br /> Career.zip
        </Heading>
        <LoginButton text="가입하기" />
      </Section>
      <Section id="about" height="1000px" padding="120px 0">
        <Heading as="h2" fontSize="46px" fontWeight="bold" mb="40px">
          ABOUT
        </Heading>
        <Text>커리어집은 킹왕장 므찐 써비스</Text>
        <Text>커리어집은 킹왕장 므찐 써비스</Text>
        <Flex mt="40px" mb="auto">
          <Image
            width="300px"
            mr="10px"
      ...
      <Section bg="lightGray" height="760px" padding="190px 0">
        ...
        <Button backgroundColor="blue" mt="auto">
          함께 성장하기
        </Button>
      </Section>
      <LandingPageFooter />
